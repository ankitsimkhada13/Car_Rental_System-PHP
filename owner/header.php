<?php require_once __DIR__ . "/owner.php";?>
       <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: black;">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://localhost/Onlinecarrental/owner/index.php">
                <div class="sidebar-brand-icon">
                <i class="fa-solid fa-house-chimney"></i>
                </div>
                <div class="sidebar-brand-text mx-3">CR owner</div>
            </a>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="topbar-divider d-none d-sm-block"></div>
                        ...
                        <a class=" d-none d-lg-inline text-black small mt-4"  href="http://localhost/Onlinecarrental/owner/profile/index.php"><?php $user = find('users', $_SESSION['user_id']);
