    ...
    <div id="wrapper" style="color: #303130;">
        ...
        <form action="update.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-control" value="<?php echo $vehicle['name']; ?>">
            </div>

            <div class="form-group">
                <label for="price">Price Per day</label>
                <input type="text" id="price" name="price" class="form-control" value="<?php echo $vehicle['price']; ?>">
            </div>

            <div class="form-group">
                <label for="model_year">Model Year</label>
                <input type="text" id="model_year" name="model_year" class="form-control" value="<?php echo $vehicle['model_year']; ?>">
            </div>

            <div class="form-group">
                <label for="seat">Seat</label>
                <input type="text" id="seat" name="seat" class="form-control" value="<?php echo $vehicle['seat']; ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="vehicle_no" name="vehicle_no" class="form-control" value="<?php echo $vehicle['vehicle_no']; ?>">
            </div>
