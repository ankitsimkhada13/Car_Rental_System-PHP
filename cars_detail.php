<?php
$pageTitle = "Car-Detail | CarRental";
...
<body>
    ...
    $rsql = "SELECT*FROM booking WHERE vehicle_id=$id  ORDER BY from_date DESC";
    $rents = query($rsql);
    ?>
    ...
    <div class="container">
        ...
        <div class="float-end mt-5">
            ...
            <form method="post" action="book.php?cid=<?php echo $id; ?>">
                ...
                <button id="payment-button" type="submit" class="btn btn-primary mt-3 mx-3" style="border-radius: 15px;" name="khalti">Pay with Khalti</button> 
